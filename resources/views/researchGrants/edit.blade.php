                ...
                <div class="p-6">
                    <form action="{{ route('researchGrants.update', $researchGrant->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="project_title" id="project_title" value="{{ $researchGrant->project_title }}" class="form-input rounded-md shadow-sm mt-1 block w-full text-black border border-black" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="grant_amount" id="grant_amount" value="{{ $researchGrant->grant_amount }}" class="form-input rounded-md shadow-sm mt-1 block w-full text-black border border-black" required>
                        </div>

                        <!-- Grant Provider -->
                        <div class="mb-6">
                            <label for="grant_provider" class="block text-sm font-medium text-black">Grant Provider</label>
                            <input type="text" name="grant_provider" id="grant_provider" value="{{ $researchGrant->grant_provider }}" class="form-input rounded-md shadow-sm mt-1 block w-full text-black border border-black" required>
                        </div>

                        <!-- Start Date -->
                        <div class="mb-6">
                            <label for="start_date" class="block text-sm font-medium text-black">Start Date</label>
                            <input type="date" name="start_date" id="start_date" value="{{ $researchGrant->start_date }}" class="form-input rounded-md shadow-sm mt-1 block w-full text-black border border-black" required>
                        </div>

                        <!-- Duration in Months -->
                        <div class="mb-6">
                            <label for="duration_months" class="block text-sm font-medium text-black">Duration (Months)</label>
                            <input type="number" name="duration_months" id="duration_months" value="{{ $researchGrant->duration_months }}" class="form-input rounded-md shadow-sm mt-1 block w-full text-black border border-black" required>
                        </div>
